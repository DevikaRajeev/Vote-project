...
<header id="header">
    <div id="stuck_container">
        <div class="container">
          ...
          <li style="font-family:Georgia, 'Times New Roman', Times, serif"> <a href="candidate_electionevent.php" ><b>Election 
            Event</b></a></li>
...
{
$ee=$_POST['ee'];
$sql = "SELECT * FROM candidate_register WHERE email='$_SESSION[username]' AND vote_event='$ee' AND status='VOTED'";
$result = mysql_query($sql);

			if (mysql_num_rows($result)==1){
	    //Login User already voted:
	   // echo $cand1;
	   echo"<script>alert('You have already been voted, No need to vote again');document.location.href='candidate_home.php';</script>";
            ...
            $sql2 = "UPDATE candidate_register SET status='VOTED',vote_event='$ee' WHERE email='$_SESSION[username]' ";
	...
	echo"<script>alert('Congratulation, you have made your vote.');document.location.href='candidate_home.php';</script>";
	//echo"$msg1";
	}
			}
...
if($enddate<$today)
{
echo"<script>alert('The $election_title election vote time is Closed!!');document.location.href='candidate_home.php';</script>";
