...
<header id="header">
    <div id="stuck_container">
        <div class="container">
            ...
            <li class="current" style="font-family:Georgia, 'Times New Roman', Times, serif"><a href="student_home.php">Home</a></li>
...
<?php
 $connect=mysql_connect("localhost","root","");
			  ...
			  $query="select * from user_register  where email='$_SESSION[username]'";
...
<div class="camera-wrapper">
    <div id="camera" class="camera-wrap">
        ...
        <div data-src="images/campus/group-of-young-people-using-technology-picture-id621895894.jpg">
		
            <div class="fadeIn camera_caption">
                <h2 class="text_1 color_1">Welcome&nbsp;&nbsp;&nbsp;<b><?php echo $name; ?></b></h2>
                
            </div>
        </div>
		
        <div data-src="images/campus/500_F_115526633_JMEifHESlEvicQUoAeQOjC9LUandyit7.jpg">
            <div class="fadeIn camera_caption">
                <h2 class="text_1 color_1">We don't build hope,we build futures.</h2>
                
            </div>
        </div>
		        <div data-src="images/campus/IMG-20180907-WA0021.jpg">
            <div class="fadeIn camera_caption">
                <h2 class="text_1 color_1">Honor the past, Support the future.</h2>
