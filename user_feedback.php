...
{
$query="insert into user_feedback(name,email,subject,message)values('$user_name','$user_email','$user_subject','$user_message')";
		...
		if($r == 1)
		{
$query="insert into login(username,password,usertype)values('$user_email','$user_password','student')";
...
<h3>
	...
	<form method="post" name="form1" id="form1" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" style="padding-left:200px" >
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="fname"  name="name" class="col-xs-10 col-sm-5" style="border: 1px solid #D5D5D5;padding: 5px 4px 6px;" />
										</div>
									</div>
