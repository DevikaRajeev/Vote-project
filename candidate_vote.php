...
?><form action="event_candidate_vote.php" method="post">
  <div class="col-sm-9"> 
    <center>
      <br />
      <input type="submit" value="<?php echo $election_title ;?>" name="submit"  class="btn" >
      <input type="hidden" name="w" value="<?php echo $election_title ;?>">
      <br />
    </center>
  </div>
</form>									<?php
