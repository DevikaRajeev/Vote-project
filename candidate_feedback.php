                ...
                <div class="grid_12">
                    ...
                    <nav class="nav put-right">
                        <ul class="sf-menu">
							...
							<li  style="font-family:Georgia, 'Times New Roman', Times, serif"><a href="candidate_electionevent.php">Election Event</a></li>
                            <li  style="font-family:Georgia, 'Times New Roman', Times, serif">
                                <a href="candidate_vote.php.php" ><b>Vote</b></a></li>
						    <li  style="font-family:Georgia, 'Times New Roman', Times, serif">
                                <a href="candidate_result.php">Result</a>
                                
                            </li>
							<li class="current" style="font-family:Georgia, 'Times New Roman', Times, serif">
                                <a href="candidate_feedback.php">Feedback</a>
...
$db=mysql_select_db("vote");
 ...
 $query="select * from candidate_register where email='$student'";
