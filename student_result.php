...
<header id="header">
    <div id="stuck_container">
        <div class="container">
          ...
          <li style="font-family:Georgia, 'Times New Roman', Times, serif"> <a href="student_candidate.php" ><b>Vote</b></a></li>
...
<div class="bg_1 wrap_7 wrap_5">
 ...
 while($res=mysql_fetch_array($result))
			 ...
			 ?>
              ...
              <p class="text_3"> <font size="+3"> <strong> <font face="Georgia, Times New Roman, Times, serif"><?php echo $discription; ?><br><center><img src="<?php echo $photo; ?>" height="180px" width="180px"><br><form action="sleading.php" method="post">
